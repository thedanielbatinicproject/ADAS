...
\begin{figure}[H]
    ...
    \caption{Player prozor s aktivnom BRAKE akcijom: crveni omeđujući pravokutnik, objekt klasificiran kao unutar ego-trake, visok risk score i TTC ispod kritičnog praga od $1{,}5$~s.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{scenario_noc.png}
    \caption{Player prozor u noćnom scenariju: prilagođeno kontekstno stanje, smanjen kontrast traka i povećana osjetljivost detekcije prepreka vidljivi su u informacijskoj traci i iznosu \textit{lane confidence}.}
